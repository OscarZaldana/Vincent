...
public class GrappleCustomInspector : Editor {
	...
	SerializedProperty reelInSpeed;						
	GUIContent label_reelInSpeed;
	SerializedProperty payOutSpeed;					
	GUIContent label_payOutSpeed;
	
	
	SerializedProperty grapplingHookRange;
